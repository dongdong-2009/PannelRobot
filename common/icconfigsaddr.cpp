...
extern  const ICAddrWrapper  s_rw_0_4_0_221(3,3,0,4,221,0,"");   //<当前定时时间轴1ID
extern  const ICAddrWrapper  s_rw_4_4_0_221(3,3,4,4,221,0,"");   //<当前定时时间轴2ID
extern  const ICAddrWrapper  s_rw_8_4_0_221(3,3,8,4,221,0,"");   //<当前定时时间轴3ID
extern  const ICAddrWrapper  s_rw_12_4_0_221(3,3,12,4,221,0,"");   //<当前定时时间轴4ID
extern  const ICAddrWrapper  s_rw_16_4_0_221(3,3,16,4,221,0,"");   //<当前定时时间轴5ID
extern  const ICAddrWrapper  s_rw_20_4_0_221(3,3,20,4,221,0,"");   //<当前定时时间轴6ID
extern  const ICAddrWrapper  s_rw_24_4_0_221(3,3,24,4,221,0,"");   //<当前定时时间轴7ID
extern  const ICAddrWrapper  s_rw_28_4_0_221(3,3,28,4,221,0,"");   //<当前定时时间轴8ID
extern  const ICAddrWrapper  s_rw_0_1_0_222(3,3,0,1,222,0,"");   //<当前定时时间安全区使能
extern  const ICAddrWrapper  s_rw_1_5_0_222(3,3,1,5,222,0,"");   //<当前定时时间安全区类型
extern  const ICAddrWrapper  s_rw_6_7_0_222(3,3,6,7,222,0,"");   //<当前定时时间输入安全信号点
extern  const ICAddrWrapper  s_rw_13_19_0_222(3,3,13,19,222,0,"");   //<当前定时时间预留
extern  const ICAddrWrapper  s_rw_0_32_3_223(3,3,0,32,223,3,"mm");    //<当前定时时间轴1最小安全位置
extern  const ICAddrWrapper  s_rw_0_32_3_224(3,3,0,32,224,3,"mm");    //<当前定时时间轴1最大安全位置
extern  const ICAddrWrapper  s_rw_0_32_3_225(3,3,0,32,225,3,"mm");    //<当前定时时间轴2最小安全位置
extern  const ICAddrWrapper  s_rw_0_32_3_226(3,3,0,32,226,3,"mm");    //<当前定时时间轴2最大安全位置
extern  const ICAddrWrapper  s_rw_0_32_3_227(3,3,0,32,227,3,"mm");    //<当前定时时间轴3最小安全位置
extern  const ICAddrWrapper  s_rw_0_32_3_228(3,3,0,32,228,3,"mm");    //<当前定时时间轴3最大安全位置
extern  const ICAddrWrapper  s_rw_0_32_3_229(3,3,0,32,229,3,"mm");    //<当前定时时间轴4最小安全位置
extern  const ICAddrWrapper  s_rw_0_32_3_230(3,3,0,32,230,3,"mm");    //<当前定时时间轴4最大安全位置
extern  const ICAddrWrapper  s_rw_0_32_3_231(3,3,0,32,231,3,"mm");    //<当前定时时间轴5最小安全位置
extern  const ICAddrWrapper  s_rw_0_32_3_232(3,3,0,32,232,3,"mm");    //<当前定时时间轴5最大安全位置
extern  const ICAddrWrapper  s_rw_0_32_3_233(3,3,0,32,233,3,"mm");    //<当前定时时间轴6最小安全位置
extern  const ICAddrWrapper  s_rw_0_32_3_234(3,3,0,32,234,3,"mm");    //<当前定时时间轴6最大安全位置
extern  const ICAddrWrapper  s_rw_0_32_3_235(3,3,0,32,235,3,"mm");    //<当前定时时间轴7最小安全位置
extern  const ICAddrWrapper  s_rw_0_32_3_236(3,3,0,32,236,3,"mm");    //<当前定时时间轴7最大安全位置
extern  const ICAddrWrapper  s_rw_0_32_3_237(3,3,0,32,237,3,"mm");    //<当前定时时间轴8最小安全位置
extern  const ICAddrWrapper  s_rw_0_32_3_238(3,3,0,32,238,3,"mm");    //<目标定时时间轴8最大安全位置
extern  const ICAddrWrapper  s_rw_0_16_3_239(3,3,0,16,239,3,"mm");   //<目标定时时间轴1最小安全位置
extern  const ICAddrWrapper  s_rw_16_16_3_239(3,3,16,16,239,3,"mm");   //<目标定时时间轴1最小安全位置
extern  const ICAddrWrapper  s_rw_0_16_3_240(3,3,0,16,240,3,"mm");   //<目标定时时间轴1最小安全位置
extern  const ICAddrWrapper  s_rw_16_16_3_240(3,3,16,16,240,3,"mm");   //<目标定时时间轴1最小安全位置
extern  const ICAddrWrapper  s_rw_0_16_3_241(3,3,0,16,241,3,"mm");   //<目标定时时间轴1最小安全位置
extern  const ICAddrWrapper  s_rw_16_16_3_241(3,3,16,16,241,3,"mm");   //<目标定时时间轴1最小安全位置
extern  const ICAddrWrapper  s_rw_0_16_3_242(3,3,0,16,242,3,"mm");   //<目标定时时间轴1最小安全位置
extern  const ICAddrWrapper  s_rw_16_16_3_242(3,3,16,16,242,3,"mm");   //<目标定时时间轴1最小安全位置
extern  const ICAddrWrapper  s_rw_0_8_3_243(3,3,0,8,243,3,"mm");   //<目标定时时间轴1最小安全位置
extern  const ICAddrWrapper  s_rw_8_8_3_243(3,3,8,8,243,3,"mm");   //<目标定时时间轴1最小安全位置
extern  const ICAddrWrapper  s_rw_16_8_3_243(3,3,16,8,243,3,"mm");   //<目标定时时间轴1最小安全位置
extern  const ICAddrWrapper  s_rw_24_8_3_243(3,3,24,8,243,3,"mm");   //<目标定时时间轴1最小安全位置
extern  const ICAddrWrapper  s_rw_0_8_3_244(3,3,0,8,244,3,"mm");   //<目标定时时间轴1最小安全位置
extern  const ICAddrWrapper  s_rw_8_8_3_244(3,3,8,8,244,3,"mm");   //<目标定时时间轴1最小安全位置
extern  const ICAddrWrapper  s_rw_16_8_3_244(3,3,16,8,244,3,"mm");   //<目标定时时间轴1最小安全位置
extern  const ICAddrWrapper  s_rw_24_8_3_244(3,3,24,8,244,3,"mm");   //<目标定时时间轴1最小安全位置
...
extern  const ICAddrWrapper  s_rw_0_32_0_288(3,3,0,32,288,0,"ms");    //<目标计数值目标计数值
extern  const ICAddrWrapper  s_rw_0_32_0_289(3,3,0,32,289,0,"ms");    //<目标计数值目标计数值
