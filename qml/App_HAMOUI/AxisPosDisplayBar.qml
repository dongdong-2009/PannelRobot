...
//                unit: AxisDefine.axisInfos[5].unit
    ...
    function onAxisDefinesChanged(){
        ...
        m0.unit = AxisDefine.axisInfos[0].unit;
        m1.unit = AxisDefine.axisInfos[1].unit;
        m2.unit = AxisDefine.axisInfos[2].unit;
        m3.unit = AxisDefine.axisInfos[3].unit;
        m4.unit = AxisDefine.axisInfos[4].unit;
        m5.unit = AxisDefine.axisInfos[5].unit;
