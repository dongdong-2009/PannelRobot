...
var valveDefines = {
    ...
    "valve6"   : new ValveItem(6,   qsTr("Normal Y016"), IO_TYPE_HOLD_DOUBLE_Y, 3, IO_BOARD_0, 6, IO_BOARD_0, 6, 1, IO_BOARD_0, 7, IO_BOARD_0, 7, 1),
//    "valve7"   : new ValveItem(7,   qsTr("Normal Y017"), IO_TYPE_NORMAL_Y, 1, IO_BOARD_0, 7),
    ...
    "valve12"  : new ValveItem(12,  qsTr("Normal Y024"), IO_TYPE_SINGLE_Y, 3, IO_BOARD_0, 12, IO_BOARD_0, 12, 1),
    "valve13"  : new ValveItem(13,  qsTr("Normal Y025"), IO_TYPE_HOLD_DOUBLE_Y, 3, IO_BOARD_0, 13, IO_BOARD_0, 13, 1, IO_BOARD_0, 14, IO_BOARD_0, 14, 1),
//    "valve14"  : new ValveItem(14,  qsTr("Normal Y026"), IO_TYPE_NORMAL_Y, 1, IO_BOARD_0, 14),
    ...
    "valve21"  : new ValveItem(21,  qsTr("Normal Y035"), IO_TYPE_HOLD_DOUBLE_Y, 3, IO_BOARD_0, 21,IO_BOARD_0, 21, 1, IO_BOARD_0, 22, IO_BOARD_0, 22, 1),
