...
Item {
    ...
    function onOriginPointDirChanged(){
        var addr = currentGroupAddr(29);
        var oldV = panelRobotController.getConfigValue(addr);
    ...
    function showMotorConfigs(which){
        ...
        updateCheckBoxValue(originPointInvert,pdata.configAddrs[which][29],onOriginPointDirChanged);
